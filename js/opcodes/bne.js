 ...
 * If the Zero flag (Z) is 0, adds a relative offset to the Program Counter (PC).
...
export function execute(cpu) {
    ...
    if (!cpu.registers.getZeroFlag()) { // Branch if Z flag is clear
    ...
    // and no extra cycles are added beyond the fetch.
}
